...
A powerful Python tool that transcribes audio files using OpenAI's GPT-4o mini transcribe API and optionally summarizes the content using GPT models. Designed to handle long audio files by automatically splitting them into manageable chunks.

## ✨ Features

- **🎯 Accurate Transcription**: Leverages OpenAI's GPT-4o mini transcribe model for high-quality speech-to-text conversion
...
3. **Transcription**: Each chunk is sent to OpenAI's GPT-4o mini transcribe API for transcription
...
```python
MODEL_TRANSCRIBE = "gpt-4o-mini-transcribe"  # GPT-4o mini transcribe model for transcription
